...
![image-20230529211541995](png/2.png)

#### HTTP响应报文：

![image-20230529211603539](png/3.png)

## 服务器基本框架：



![image-20230530093455890](png/4.png)
...
![image-20230530100536828](png/5.png)

![image-20230530100606467](png/6.png)
...
![image-20230530103503341](png/7.png)
...
![image-20230601110901010](png/8.png)



**从状态机负责读取报文的一行，主状态机负责对该行数据进行解析**，主状态机内部调用从状态机，从状态机驱动主状态机。

![image-20230616151029463](png/9.png)
...
![image-20230605155942890](png/10.png)

响应报文格式：

![image-20230605172112239](png/11.png)
...
![image-20230628180536519](png/12.png)
...
![image-20230702163200070](png/13.png)

##### 函数1：对用户传递进来的数据报文进行解析，然后服务器返回用户所请求的数据

![image-20230702165306827](png/14.png)
...
![image-20230702162756497](png/15.png)

例如：请求首行函数解析完毕，切换主状态机状态：![image-20230702162606709](png/16.png)

进入处理请求函数：

![image-20230702164203596](png/17.png)
...
![image-20230702164517453](png/18.png)
...
![image-20230702170015496](png/19.png)
